...
public class Trolleybus extends GroundTransport implements IMaxSpeed {
    ...
    Trolleybus(int number, int[] timetable, int fuel, Route route, Passanger[] passangers, Driver driver, Controllers controller, Types typeOfFuel, Validator validator){
